"""k-WTA ratio ablation: systematically test k_frac = 5%, 10%, 15%, 25%.

Each config trains a flynetS_adaptive arm for 4000 steps on the 53M corpus.
After training, measures: val loss, top-1 accuracy, ECE, distinct3.
Purpose: find the optimal sparsity ratio and test if the calibration gain
is robust across sparsity levels.
"""
...
class KWTA(nn.Module):
    """Top-k channel sparsification via kthvalue threshold."""
